...
- When you know the specific line number(s) of a function, class, or important code location, include the line reference: [[file:path/to/file.ts:42]] for a single line or [[file:path/to/file.ts:42-58]] for a range. This will highlight the exact code in the viewer. For example: "The spawn function starts at [[file:src/codex.rs:436]]" or "The session initialization is at [[file:core/src/codex.rs:647-660]]".
- Always reference at least 1-3 relevant files per answer using the [[file:...]] syntax when discussing code structure, architecture, or implementation details. Prefer line-specific references when you can identify the exact location.
